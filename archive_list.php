<?php
	require_once('dbconnect.php');
		...
		$sql = "SELECT * FROM archive ORDER BY date_departure";
...
<html>
	...
	<?php
			...
			while($row = $result->fetch_assoc()) {
				...
				$date = date_create($row['date_departure']);
			
			echo "<table class='table table-bordered' style='width: 50%; margin: 20px auto; background-color: white;'>
				<thead>
					<tr>
						<th class='text-center' style='padding: 20px !important;' colspan='2'>".$row['tag_number']."</p></th>
					</tr>
				</thead>
				...
				<tr>
					<td style='font-weight: bold'>Archive Date</td>
